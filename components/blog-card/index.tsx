...
const BlogCard = ({ blog }: Props) => {
  return (
    <Link href={`/blog/${blog._meta.uid}`} passHref>
      <div className="flex items-center mb-8 rounded-md cursor-pointer hover:drop-shadow-xl w-full py-8 px-6 drop-shadow-md bg-[#ededed]  border-[#C7A291] border-[1px]">
        <div className="group flex flex-col flex-1">
          ...
          <article className="text-[14px] mt-3 text-[#605f5f] md:max-w-[90%]">
